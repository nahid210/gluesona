    ...
    public function customers()
    {
        ...
        if(request()->ajax()) {
            ...
            ->addColumn('created_at', function($data){
                return '<span class="badge badge-success-light">'.$data->created_at->format(setting('date_format')).'</span><br>Last Login Details:<br> <span class="badge badge-danger-light">'.$data->last_login_ip.'</span><br> <span class="badge badge-danger-light">'.$data->last_login_at.'</span>';
            })
