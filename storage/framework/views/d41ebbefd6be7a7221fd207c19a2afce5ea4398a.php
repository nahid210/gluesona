		...
		<?php $__env->stopSection(); ?>
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2"><?php echo e(trans('langconvert.adminmenu.alltickets')); ?></span></h4>
								</div>
							</div>
							<!--End Page header-->
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card ">
									<div class="card-header border-0">
										<h4 class="card-title"><?php echo e(trans('langconvert.adminmenu.alltickets')); ?></h4>
									</div>
									<div class="card-body" >
		...
		<script type="text/javascript">
			...
			(function($)  {
				...
				var table = $('#myticket').DataTable({
					...
					serverSide:true,
					ajax: {
						url: "<?php echo e(url('admin/alltickets')); ?>"
					},
					columns: [
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/admin/viewticket/alltickets.blade.php ENDPATH**/ ?>