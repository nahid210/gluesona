									<?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="card-body" >
													<div class="d-sm-flex">
														...
														<div class="media-body">
															<h5 class="mt-1 mb-1 font-weight-semibold"><?php echo e($comment->cust->username); ?></h5>
															...
															<div class="editsupportnote-icon animated" id="supportnote-icon-<?php echo e($comment->id); ?>">
																<form action="<?php echo e(url('/guestticket/editcomment/'.$comment->id)); ?>" method="POST">
																	<?php echo csrf_field(); ?>
															...
															<div class="row galleryopen">
																	...
																	<div class="file-image-1  removespruko<?php echo e($commentss->id); ?>" id="imageremove<?php echo e($commentss->id); ?>">
																		<div class="product-image  ">
																			...
																			<ul class="icons">
																				<li><a href="javascript:(0);" class="bg-danger imgdel" data-id="<?php echo e($commentss->id); ?>"><i class="fe fe-trash" data-id="<?php echo e($commentss->id); ?>"></i><?php echo csrf_field(); ?></a></li>
																			</ul>
																		</div>
											...
											<?php else: ?>
												<div class="card-body" >
													<div class="d-sm-flex">
														...
														<div class="media-body">
															<h5 class="mt-1 mb-1 font-weight-semibold"><?php echo e($comment->cust->name); ?></h5>
															<small class="text-muted"><i class="feather feather-clock"></i> <?php echo e($comment->created_at->diffForHumans()); ?></small>
															<div class="fs-13 mb-0 mt-1" >
																<?php echo $comment->comment; ?>
										...
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/guestticket/showdataticket.blade.php ENDPATH**/ ?>