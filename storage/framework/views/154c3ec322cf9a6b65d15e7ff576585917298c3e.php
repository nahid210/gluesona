		...
		<!-- Custom html js-->
		<script src="<?php echo e(asset('assets/js/custom.js')); ?>?v=<?php echo time(); ?>"></script><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/includes/scripts.blade.php ENDPATH**/ ?>