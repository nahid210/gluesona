								...
								<div class="pb-3 px-5 pt-3">
									...
									<p class="text-muted  mb-0"><?php echo e(trans('langconvert.menu.siginacc')); ?></p>
								</div>
								...
								<form class="card-body border-top-0 pt-3" id="login" action="<?php echo e(route('client.do_login')); ?>" method="post">
									<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Email" type="email"
											value="<?php echo e(old('email')); ?>" name="email" autocomplete="username">
...
unset($__errorArgs, $__bag); ?>" placeholder="password" type="password" name="password" autocomplete="current-password">
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="form-group">
										<label class="custom-control form-checkbox">
											<input type="checkbox" class="custom-control-input" name="remember" id="remember" <?php echo e(old('remember')
												? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="submit">
										<input class="btn btn-secondary btn-block" type="submit" value="<?php echo e(trans('langconvert.menu.login')); ?>"
											onclick="this.disabled=true;this.form.submit();">
									</div>
									<div class="text-center mt-3">
										<a href="<?php echo e(url('customer/forgotpassword')); ?>" class="text-primary pb-2"><?php echo e(trans('langconvert.menu.forgotpass')); ?></a>
										<?php if(setting('REGISTER_DISABLE') == 'on'): ?>

										<p class="text-dark mb-0"><?php echo e(trans('langconvert.menu.doyoulogin')); ?><a class="text-primary ms-1"
												href="<?php echo e(route('auth.register')); ?>"><?php echo e(trans('langconvert.menu.register')); ?></a></p>
										<?php endif; ?>
										
										<p class="text-dark mb-0"><a class="text-primary ms-1" href="<?php echo e(url('/')); ?>"><?php echo e(trans('langconvert.menu.meback')); ?></a></p>
									</div>
								</form>
								<!--Login Page-->
		...
		<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custommaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/user/auth/login.blade.php ENDPATH**/ ?>