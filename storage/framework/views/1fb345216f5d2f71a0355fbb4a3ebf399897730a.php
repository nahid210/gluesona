		...
		<div class="page error-bg">
			<div class="page-content m-0">
				<div class="container text-center">
					...
					<a class="btn btn-success" href="<?php echo e(url('/')); ?>"><i class="fe fe-arrow-left-circle me-1"></i>Back to Home</a>
				</div>
			</div>
		</div>
		<!--Row-->
...
</html><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/errors/404.blade.php ENDPATH**/ ?>