...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" >
	...
	<body class="<?php if(str_replace('_', '-', app()->getLocale()) == 'عربى'): ?> rtl <?php endif; ?>
	...
	<?php endif; ?>">
				...
				<div class="alert alert-success br-0 mb-0" role="alert">
					...
					<?php echo e($anct->title); ?>

					<?php echo $anct->notice; ?>
...
</html><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/layouts/master.blade.php ENDPATH**/ ?>