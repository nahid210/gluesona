								...
								<!--Register Page-->
								<div class="p-5 pt-0">
									<h1 class="mb-2"><?php echo e(trans('langconvert.menu.register')); ?></h1>
									<p class="text-muted"><?php echo e(trans('langconvert.menu.createnew')); ?></p>
								</div>
								...
								<form class="card-body border-top-0 pt-3" method="post" action="<?php echo e(route('auth.register')); ?>">
									<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Firstname" type="text"
...
unset($__errorArgs, $__bag); ?>" placeholder="Lastname" type="text"
...
unset($__errorArgs, $__bag); ?>" placeholder="Email" type="email" name="email"
...
unset($__errorArgs, $__bag); ?>" placeholder="password" type="password"
...
unset($__errorArgs, $__bag); ?>">
										<label class="custom-control form-checkbox">
											...
											<span class="custom-control-label"><?php echo e(trans('langconvert.userdashboard.iagree')); ?> <a href="<?php echo e(setting('terms_url')); ?>" class="text-primary">
													<?php echo e(trans('langconvert.userdashboard.termsservices')); ?></a></span>
										</label>
									</div>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="submit">
										<input type="submit" class="btn btn-secondary btn-block" value="<?php echo e(trans('langconvert.menu.createnewacc')); ?>"
											onclick="this.disabled=true;this.form.submit();" />

									</div>
									<div class="text-center mt-4">
										<p class="text-dark mb-0"><?php echo e(trans('langconvert.menu.alreadyacc')); ?><a class="text-primary ms-1"
												href="<?php echo e(url('customer/login')); ?>"><?php echo e(trans('langconvert.menu.login')); ?></a></p>
		...
		<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custommaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/user/auth/register.blade.php ENDPATH**/ ?>