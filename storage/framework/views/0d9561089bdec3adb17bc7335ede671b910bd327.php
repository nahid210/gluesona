                                    <li class="dropdown me-3 header-message">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow p-0 notification-dropdown-container">
                                                    ...
                                                    <?php if($notification->data['status'] == 'New'): ?>
                                                        ...
                                                        <a class="dropdown-item border-bottom mark-as-read" href="<?php echo e($notification->data['clink']); ?>" data-id="<?php echo e($notification->id); ?>">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="ps-3">
                                                                        <h6 class="mb-1"><?php echo e(Str::limit($notification->data['title'], '100')); ?></h6>
                                            ...
                                            <div class=" text-center p-2">
                                                <a href="<?php echo e(route('client.notification')); ?>" class="cmark-all"><?php echo e(trans('langconvert.usermenu.allnotify')); ?> (<?php echo e(auth()->guard('customer')->user()->notifications->count()); ?>)</a>
                                            </div>
                                        </div>

                                    </li><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/includes/user/notifynotication.blade.php ENDPATH**/ ?>