                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" enctype="multipart/form-data" id="testimonial_form" name="testimonial_form">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label"><?php echo e(trans('langconvert.admindashboard.noticetext')); ?><span class="text-red">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label"><?php echo e(trans('langconvert.admindashboard.startdate')); ?>: <span class="text-red">*</span></label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label"><?php echo e(trans('langconvert.admindashboard.enddate')); ?>: <span class="text-red">*</span></label>
                                                    <div class="input-group">
                                                        <div class="input-group-text">
                                                            <i class="feather feather-calendar"></i>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="switch_section">
                                                <div class="switch-toggle d-flex mt-4">
                                                    <label class="form-label pe-2"><?php echo e(trans('langconvert.admindashboard.status')); ?></label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-secondary" id="btnsave"  ><?php echo e(trans('langconvert.admindashboard.save')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    </div>
                    <!-- End  Add Announcement  --><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/admin/announcement/model.blade.php ENDPATH**/ ?>