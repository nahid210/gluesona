								...
								<div class="col-md-12">
									<div class="card overflow-hidden">
										<div class="card-body p-0">
											...
											<form method="POST" action="<?php echo e(route('settings.sociallogin.update')); ?>" enctype="multipart/form-data">
												<?php echo csrf_field(); ?>
														...
														<div class="tab-pane active" id="envato">
																	...
																	<div class="switch_section p-0 m-0">
																		<div class="switch-toggle float-end d-flex">
																			<a class="onoffswitch2 switch-lg">
																				<input type="checkbox" id="myonoffswitch18789" name="envato_status" class=" toggle-class onoffswitch2-checkbox" <?php if($credentials->envato_status == 'enable'): ?> checked <?php endif; ?>>
															...
															<div class="p-5 main-settings-content" id="envatoSettings">
																<div class="form-group ">
																	...
																	<input type="text" name="envato_client_id" id="envato_client_id" class="form-control  <?php $__errorArgs = ['envato_client_id'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->envato_client_id); ?>">
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group ">
																	...
																	<input type="password" name="envato_secret_id" id="envato_secret_id" class="form-control  <?php $__errorArgs = ['envato_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->envato_secret_id); ?>" autocomplete="new-password">
																	<?php $__errorArgs = ['envato_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group">
																	...
																	<p class="text-bold p-2 bg-light br-7 mb-1"><?php echo e(route('social.login-callback', 'envato')); ?></p>
																	<small class="text-muted"><i><?php echo e(trans('langconvert.admindashboard.envatologinconrent')); ?></i></small>
																</div>
															</div>
														...
														<div class="tab-pane" id="google">
															...
															<div class="p-5 main-settings-content" id="googleSettings">
																...
																<div class="form-group ">
																	...
																	<input type="text" name="google_client_id" id="google_client_id" class="form-control  <?php $__errorArgs = ['google_client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->google_client_id); ?>">
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group ">
																	...
																	<input type="password" name="google_secret_id" id="google_secret_id" class="form-control  <?php $__errorArgs = ['facebook_client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->google_secret_id); ?>" autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group">
																	<label>Callback/Redirect URL</label>
																	<p class="text-bold p-2 bg-light br-7 mb-1"><?php echo e(route('social.login-callback', 'google')); ?></p>
																	<small class="text-muted"><i><?php echo e(trans('langconvert.admindashboard.googleloginconrent')); ?></i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
														...
														<div class="tab-pane" id="facebook">
															...
															<div class="p-5 main-settings-content" id="facebookSettings">
																<div class="form-group ">
																	...
																	<input type="text" name="facebook_client_id" id="facebook_client_id" class="form-control <?php $__errorArgs = ['facebook_client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->facebook_client_id); ?>">
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group ">
																	...
																	<input type="password" name="facebook_secret_id" id="facebook_secret_id" class="form-control <?php $__errorArgs = ['facebook_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->facebook_secret_id); ?>" autocomplete="new-password">
																	<?php $__errorArgs = ['facebook_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group">
																	<label>Callback/Redirect URL</label>
																	<p class="text-bold p-2 bg-light br-7 mb-1"><?php echo e(route('social.login-callback', 'facebook')); ?></p>
																	<small class="text-muted"><i><?php echo e(trans('langconvert.admindashboard.facebookloginconrent')); ?></i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
														...
														<div class="tab-pane" id="twitter">
															...
															<div class="p-5 main-settings-content" id="twitterSettings">
																<div class="form-group ">
																	...
																	<input type="text" name="twitter_client_id" id="twitter_client_id" class="form-control <?php $__errorArgs = ['twitter_client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->twitter_client_id); ?>">
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group ">
																	...
																	<input type="password" name="twitter_secret_id" id="twitter_secret_id" class="form-control <?php $__errorArgs = ['twitter_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($credentials->twitter_secret_id); ?>" autocomplete="new-password">
																	<?php $__errorArgs = ['twitter_secret_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
																...
																<div class="form-group">
																	<label>Callback/Redirect URL</label>
																	<p class="text-bold p-2 bg-light br-7 mb-1"><?php echo e(route('social.login-callback', 'twitter')); ?></p>
																	<small class="text-muted"><i><?php echo e(trans('langconvert.admindashboard.twitterloginconrent')); ?></i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/admin/generalsetting/socialloginsetting.blade.php ENDPATH**/ ?>