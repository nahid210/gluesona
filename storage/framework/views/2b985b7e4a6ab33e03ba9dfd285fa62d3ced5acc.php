							...
							<div class="d-flex">
								<div class="headerlanding-logo">
									<a class="header-brand" href="<?php echo e(url('/')); ?>">
										...
										<?php if($title->image1 !== null): ?>
											...
											<img src="<?php echo e(asset('uploads/logo/darklogo/'.$title->image1)); ?>" class="header-brand-img light-logo"
								...
								<nav class="horizontalMenu clearfix order-lg-2 my-auto ms-auto">
									<ul class="horizontalMenu-list custom-ul">
										<li>
											<a class="active" href="<?php echo e(route('home')); ?>"><?php echo e(trans('langconvert.menu.home')); ?></a>
										</li>
				...
				<!--Header--><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/includes/menu.blade.php ENDPATH**/ ?>