                                ...
                                <div class="dropdown user-pro-body text-center">
                                    <div class="user-pic">
                                        <?php if(Auth::user()->image == null): ?>
                                            ...
                                            <img src="<?php echo e(asset('uploads/profile/user-profile.png')); ?>" class="avatar-xxl rounded-circle mb-1" alt="default">
                                        <?php else: ?>

                                            <img src="<?php echo e(asset('uploads/profile/'.Auth::user()->image)); ?>" class="avatar-xxl rounded-circle mb-1" alt="<?php echo e(Auth::user()->image); ?>">
                                        <?php endif; ?>
                            ...
                            <ul class="side-menu custom-ul">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('admin/')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.menu.dashboard')); ?></span>
                                    </a>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/profile')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.menu.profile')); ?></span>
                                    </a>
                                </li>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Ticket Access')): ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.menu.ticket')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Ticket Create')): ?>

                                        <li><a href="<?php echo e(url('/admin/createticket')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.createticket')); ?></a></li>
                                        <?php endif; ?>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('All Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/alltickets')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.alltickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('My Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/myticket')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.mytickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Active Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/activeticket')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.activetickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Closed Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/closedticket')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.closetickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Assigned Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/assignedtickets')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.assigntickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('My Assigned Tickets')): ?>

                                        <li><a href="<?php echo e(url('/admin/myassignedtickets')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.myassigntickets')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Onhold Tickets')): ?>

                                        <li><a href="<?php echo e(route('admin.onholdticket')); ?>" class="slide-item"> <?php echo e(trans('langconvert.adminmenu.onholdtickets')); ?> </a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Overdue Tickets')): ?>

                                        <li><a href="<?php echo e(route('admin.overdueticket')); ?>" class="slide-item"> <?php echo e(trans('langconvert.adminmenu.overduetickets')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.categories')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Category Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/categories')); ?>" class="slide-item"><?php echo e(trans('langconvert.newwordslang.maincategories')); ?></a></li>
                                        <?php endif; ?>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Subcategory Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/subcategories')); ?>" class="slide-item"><?php echo e(trans('langconvert.newwordslang.subcategory')); ?></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.menu.knowledge')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Article Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/article')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.articles')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/projects')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.projects')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.manageroles')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Roles & Permission Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/role')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.rolespermission')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Roles & Permission Create')): ?>

                                        <li><a href="<?php echo e(url('/admin/employee/create')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.createemployee')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Employee Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/employee')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.employeeslist')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.landingpagesetting')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Banner Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/bannersetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.banner')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Feature Box Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/feature-box')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.featurebox')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Call To Action Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/call-to-action')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.callactionbox')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Testimonial Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/testimonial')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.testimonial')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('FAQs Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/faq')); ?>" class="slide-item"><?php echo e(trans('langconvert.menu.faq')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/customer')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.customers')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(route('admin.cannedmessages')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.newwordslang.cannedresponse')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.newwordslang.envato')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('admin.envatoapitoken')); ?>" class="slide-item"><?php echo e(trans('langconvert.newwordslang.envatolicense')); ?></a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Envato License Details Access')): ?>

                                        <li>
                                            <a href="<?php echo e(route('admin.envatolicensesearch')); ?>" class="slide-item"><?php echo e(trans('langconvert.newwordslang.envatolicensesearch')); ?></a>
                                        </li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.newwordslang.appinfo')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('App Purchase Code Access')): ?>

                                        <li>
                                            <a href="<?php echo e(route('admin.licenseinfo')); ?>" class="slide-item"><?php echo e(trans('langconvert.newwordslang.appcode')); ?></a>
                                        </li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.groups')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Groups Create')): ?>

                                        <li><a href="<?php echo e(url('/admin/groups/create')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.creategroup')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Groups List Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/groups')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.grouplist')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.notification')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <li><a href="<?php echo e(route('notificationpage')); ?>" class="slide-item smark-all" ><?php echo e(trans('langconvert.adminmenu.allnotifys')); ?></a></li>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Custom Notifications Access')): ?>

                                        <li><a href="<?php echo e(route('mail.index')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.customnotify')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.custompages')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Pages Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/pages')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.pages')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('404 Error Page Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/error404')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.404errorpage')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Under Maintanance Page Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/maintenancepage')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.undermaintanenece')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.appsetting')); ?></span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('General Setting Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/general')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.generalsetting')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Ticket Setting Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/ticketsetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.ticketsetting')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('SEO Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/seo')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.seo')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Google Analytics Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/googleanalytics')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.googleanalytics')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Custom JS & CSS Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/customcssjssetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.customjscss')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Captcha Setting Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/captcha')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.captchasetting')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Social Logins Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/sociallogin')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.sociallogin')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Email Setting Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/emailsetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.emailsetting')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Custom Chat Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/customchatsetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.admindashboard.externalchat')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Maintenance Mode Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/maintenancemode')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.maintanacemode')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('SecruitySetting Access')): ?>

                                        <li><a href="<?php echo e(url('/admin/securitysetting')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.securitysetting')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('IpBlock Access')): ?>

                                        <li><a href="<?php echo e(route('ipblocklist')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.iplist')); ?></a></li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Emailtoticket Access')): ?>

                                        <li><a href="<?php echo e(route('admin.emailtoticket')); ?>" class="slide-item"><?php echo e(trans('langconvert.adminmenu.emailtoticket')); ?></a></li>
                                        <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/announcement')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.announcements')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/emailtemplates')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.emailtemplate')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item"  href="<?php echo e(url('/admin/reports')); ?>">
                                        ...
                                        <span class="side-menu__label"><?php echo e(trans('langconvert.adminmenu.report')); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
...
<?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/includes/admin/verticalmenu.blade.php ENDPATH**/ ?>