					...
					<div class="row">
								...
								<div class="card">
									<div class="card-body text-center item-user">
										<div class="profile-pic">
											...
											<small class="text-muted "><?php echo e($ticket->cust->email); ?></small>
										</div>
									</div>
								</div>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<?php elseif($ticket->replystatus == "Waiting Response"): ?>
						...
						<div class="col-xl-8">
							...
							<div class="card">
								...
								<form method="POST" action="<?php echo e(url('guest/ticket/'. $ticket->ticket_id)); ?>" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="comment" rows="6" cols="100" aria-multiline="true"></textarea>
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="form-group">
											<div class="custom-controls-stacked d-md-flex">
												...
												<label class="custom-control form-radio success me-4">
													...
													<?php elseif($ticket->status == 'Inprogress'): ?>
													<input type="radio" class="custom-control-input" name="status" value="<?php echo e($ticket->status); ?>"
							...
							<?php else: ?>
								<?php if(setting('USER_REOPEN_ISSUE') == 'yes'): ?>
									...
									<div class="card">
										<form method="POST" action="<?php echo e(url('guest/closed/' .$ticket->ticket_id)); ?>">
											<?php echo csrf_field(); ?>
											<?php echo view('honeypot::honeypotFormFields'); ?>
											<input type="hidden" name="ticket_id" value="<?php echo e($ticket->id); ?>">
											<div class="card-body">
												...
												<input type="submit" class="btn btn-secondary" value="<?php echo e(trans('langconvert.admindashboard.reopen')); ?>" onclick="this.disabled=true;this.form.submit();"> </p>
											</div>
										</form>
									</div>
									<?php else: ?>
							...
							<!---- Comments Display ---->
								...
								<div class="card support-converbody" >
									...
									<div id="spruko_loaddata">
										...
										<?php echo $__env->make('guestticket.showdataticket', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		...
		<script src="<?php echo e(asset('assets/plugins/dropzone/min/dropzone.min.js')); ?>?v=<?php echo time(); ?>"></script>
				...
				$('body').on('click', '.imgdel', function () {
					...
					.then((willDelete) => {
						if (willDelete) {
							$.ajax({
								type: "DELETE",
								url: "<?php echo e(url('/image/delete/')); ?>"+'/'+product_id,
								data: {
...
<?php echo $__env->make('layouts.usermaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/guestticket/show.blade.php ENDPATH**/ ?>