		...
		<link href="<?php echo e(asset('assets/plugins/datatable/buttonbootstrap.min.css')); ?>?v=<?php echo time(); ?>" rel="stylesheet" />
  		...
  		<?php $__env->stopSection(); ?>
							...
							<div class="page-header d-xl-flex d-block">
								...
								<h4 class="page-title"><span class="font-weight-normal text-muted ms-2"><?php echo e(trans('langconvert.adminmenu.report')); ?></span></h4>
								</div>
							</div>
							<!--End Page header-->
							...
							<div class="row">
								<div class="col-xl-4 col-md-4 col-lg-4">
									<div class="card">
										<div class="card-header border-0">
											<h4 class="card-title"><?php echo e(trans('langconvert.admindashboard.employees')); ?></h4>
										</div>
										<div class="card-body">
											<div id="userchart" class=""></div>
											<div class="sales-chart pt-5 pb-3 d-flex mx-auto text-center justify-content-center ">
												<div class="d-flex me-5"><span class="dot-label bg-success me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.active')); ?></div>
												<div class="d-flex"><span class="dot-label bg-warning  me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.inactive')); ?></div>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xl-4 col-md-4 col-lg-4">
									<div class="card">
										<div class="card-header border-0">
											<h4 class="card-title"><?php echo e(trans('langconvert.adminmenu.customers')); ?></h4>
										</div>
										<div class="card-body">
								...
								<div class="col-xl-4 col-md-4 col-lg-4">
									<div class="card">
										<div class="card-header border-0">
											<h4 class="card-title"><?php echo e(trans('langconvert.menu.ticket')); ?></h4>
										</div>
										<div class="card-body">
											<div id="ticketchart" class=""></div>
											<div class="sales-chart pt-5 pb-3 d-flex mx-auto text-center justify-content-center ">
												<div class="d-flex me-2"><span class="dot-label bg-success me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.new')); ?></div>
												<div class="d-flex me-2"><span class="dot-label bg-info  me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.inprogress')); ?></div>
												<div class="d-flex me-2"><span class="dot-label bg-warning  me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.onhold')); ?></div>
												<div class="d-flex me-2"><span class="dot-label bg-teal  me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.reopen')); ?></div>
												<div class="d-flex me-2"><span class="dot-label bg-danger  me-2 my-auto"></span><?php echo e(trans('langconvert.admindashboard.closed')); ?></div>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xl-12 col-md-12 col-lg-12">
									<div class="card">
										<div class="card-header border-0">
											<h4 class="card-title"><?php echo e(trans('langconvert.admindashboard.employeereports')); ?></h4>
										</div>
										<div class="card-body">
												...
												<table class="table table-vcenter text-nowrap table-bordered w-100" id="reports">
													<thead>
														<tr>
															...
															<th ><?php echo e(trans('langconvert.admindashboard.employeeiD')); ?></th>
															<th ><?php echo e(trans('langconvert.admindashboard.name')); ?></th>
															<th ><?php echo e(trans('langconvert.admindashboard.rating')); ?></th>
															<th ><?php echo e(trans('langconvert.admindashboard.replycount')); ?></th>
														</tr>
													</thead>
													<tbody>
		...
		<script type="text/javascript">
						...
						donut: {
							...
							labels: {
								...
								total: 
								{
									show: true,
									showAlways: false,
									label: '<?php echo e(trans('langconvert.admindashboard.total')); ?>',
									fontSize: '22px',
									fontWeight: 600,
									color: '#373d3f',
								}
			...
			// Ticket Chart
			var ticketchart = {
				series: [<?php echo e($newticket); ?>,<?php echo e($inprogressticket); ?>,<?php echo e($onholdticket); ?>,<?php echo e($reopenticket); ?>,<?php echo e($closedticket); ?>],
				chart: {
					height:300,
					type: 'donut',
				},
			...
			(function ($) {
				...
				$('#reports').DataTable({
					...
					serverSide: true,
					ajax: {
						url: "<?php echo e(url('admin/reports')); ?>"
					},
					columns: [
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bahonbdc/public_html/ticket/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>